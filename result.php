...
<body>
    ...
    <section class="wrapper">
        <h3 class="section__title"><b>Lalla</b><span>Shop</span></h3>
    ...
    <!--Footer-->
    <footer class="footer">
        <p class="footer__text">A project made by <a href="https://www.youtube.com/channel/UCbzJMya81gOqGFD9CKg3mMw?view_as=subscriber" target="_blank" rel="noopener"
