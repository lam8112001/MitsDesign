    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active"><!-- active Begin -->
                ...
                <i class="fa fa-dashboard"></i> Bảng điều khiển / Chèn sản phẩm
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel-heading Begin -->
               ...
               <h3 class="panel-title"><!-- panel-title Begin -->
                   ...
                   <i class="fa fa-money fa-fw"></i> Chèn Sản Phẩm
...
if (isset($_POST['submit'])) {
    ...
    $insert_product = "insert into products (product_category_id, category_id, date, product_title, product_image_1, product_image_2, product_image_3, product_price, product_keywords, product_description, product_label, product_sale)
                                     values ('$product_category', '$category', NOW(), '$product_title', '$product_image_1', '$product_image_2', '$product_image_2', '$product_price', '$product_keywords', '$product_description', '$product_label', '$product_sale')";
